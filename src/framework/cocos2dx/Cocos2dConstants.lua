...
cc.Handler.SCHEDULE        = 2
cc.Handler.TOUCHES         = 3
cc.Handler.KEYPAD          = 4
cc.Handler.ACCELEROMETER   = 5
cc.Handler.WEBSOCKET_OPEN           = 6
cc.Handler.WEBSOCKET_MESSAGE        = 7
cc.Handler.WEBSOCKET_CLOSE          = 8
cc.Handler.WEBSOCKET_ERROR          = 9
cc.Handler.GL_NODE_DRAW             = 10
cc.Handler.ARMATURE_EVENT         = 11
cc.Handler.EVENT_ACC              = 12
cc.Handler.EVENT_CUSTIOM          = 13
cc.Handler.EVENT_KEYBOARD_PRESSED = 14
cc.Handler.EVENT_KEYBOARD_RELEASED = 15
cc.Handler.EVENT_TOUCH_BEGAN      = 16
cc.Handler.EVENT_TOUCH_MOVED      = 17
cc.Handler.EVENT_TOUCH_ENDED      = 18
cc.Handler.EVENT_TOUCH_CANCELLED  = 19
cc.Handler.EVENT_TOUCHES_BEGAN    = 20
cc.Handler.EVENT_TOUCHES_MOVED    = 21
cc.Handler.EVENT_TOUCHES_ENDED    = 22
cc.Handler.EVENT_TOUCHES_CANCELLED = 23
cc.Handler.EVENT_MOUSE_DOWN       = 24
cc.Handler.EVENT_MOUSE_UP         = 25
cc.Handler.EVENT_MOUSE_MOVE       = 26
cc.Handler.EVENT_MOUSE_SCROLL     = 27
cc.Handler.EVENT_SPINE            = 28
cc.Handler.EVENT_PHYSICS_CONTACT_BEGIN = 29
cc.Handler.EVENT_PHYSICS_CONTACT_PRESOLVE = 30
cc.Handler.EVENT_PHYSICS_CONTACT_POSTSOLVE = 31
cc.Handler.EVENT_PHYSICS_CONTACT_SEPERATE = 32
